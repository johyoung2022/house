...
$pg_anchor = '<ul class="anchor content-box-desc">
...
<section id="anc_bo_design">
    ...
    <div class="tbl_frm01 tbl_wrap content-box">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="bo_gallery_cols" value="<?php echo $board['bo_gallery_cols'] ?>" id="bo_gallery_cols" required class="numeric frm_input" size="4">
